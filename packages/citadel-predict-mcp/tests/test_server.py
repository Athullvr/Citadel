...
@pytest.mark.asyncio
async def test_estimate_agent_cost_success(mcp_server):
    mock_prediction = {
    ...
    with patch("citadel_predict_mcp.server.predict_cost", return_value=mock_prediction) as mock_predict:
        ...
        # FastMCP / MCPServer outputs JSON string in text content
...
@pytest.mark.asyncio
async def test_auth_error_translation(mcp_server):
    with patch(
...
@pytest.mark.asyncio
async def test_rate_limit_error_translation(mcp_server):
    with patch(
        "citadel_predict_mcp.server.predict_cost",
...
@pytest.mark.asyncio
async def test_validation_error_translation(mcp_server):
    with patch(
        "citadel_predict_mcp.server.predict_cost",
...
@pytest.mark.asyncio
async def test_bad_request_error_translation(mcp_server):
    with patch(
        "citadel_predict_mcp.server.predict_cost",
...
@pytest.mark.asyncio
async def test_server_error_translation(mcp_server):
    with patch(
        "citadel_predict_mcp.server.predict_cost",
...
@pytest.mark.asyncio
async def test_network_error_translation(mcp_server):
    with patch(
        "citadel_predict_mcp.server.predict_cost",
...
@pytest.mark.asyncio
async def test_generic_citadel_error_translation(mcp_server):
    with patch(
        "citadel_predict_mcp.server.predict_cost",
...
@pytest.mark.asyncio
async def test_unexpected_exception_handling(mcp_server):
    with patch(
        "citadel_predict_mcp.server.predict_cost",
...
def test_main_entrypoint():
    with patch("citadel_predict_mcp.server.server.run") as mock_run:
        main()
