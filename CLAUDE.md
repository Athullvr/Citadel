...
```json
{
  "mcpServers": {
    "citadel-predict": {
      "command": "C:\\Users\\Athul VR\\OneDrive\\Desktop\\Citadel\\data_collection\\.venv\\Scripts\\citadel-predict-mcp.exe",
      "env": {
        "CITADEL_API_KEY": "cp_live_your_key_here",
...
**Add Server via CLI:**
```bash
claude mcp add citadel-predict -- "C:\Users\Athul VR\OneDrive\Desktop\Citadel\data_collection\.venv\Scripts\citadel-predict-mcp.exe"
```
